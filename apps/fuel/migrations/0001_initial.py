    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                'indexes': [models.Index(fields=['city', 'state'], name='fuel_fuelst_city_434708_idx'), models.Index(fields=['retail_price'], name='fuel_fuelst_retail__3784a3_idx')],
            },
        ),
        migrations.CreateModel(
            name='RouteCache',
            ...
            options={
                'constraints': [models.UniqueConstraint(fields=('start', 'destination'), name='unique_cached_route')],
            },
        ),
    ]
